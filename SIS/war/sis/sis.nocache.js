...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "sis" because\n';
 ...
 * "/sis.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['sis'].superdevmode = true;

  var expectedSuffix = '/sis.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + sis + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:sis';
  var devModeSessionKey = '__gwtDevModeSession:sis';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/sis/sis.nocache.js';
  ...
  $wnd.__gwt_activeModules['sis'].canRedirect = true;
  $wnd.__gwt_activeModules['sis'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/sis?user.agent=' + ua + '&_callback=' + callback;
